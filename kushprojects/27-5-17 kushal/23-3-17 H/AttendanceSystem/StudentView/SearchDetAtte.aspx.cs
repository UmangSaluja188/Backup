...
{
    public partial class SearchDetAtte : System.Web.UI.Page
    {
...
"Where StudentDetails.StudentId='" + StudentId + "'AND SubjectDetails.SubjectName='" + SubjectName + "' ", con);
        ...
        {
            DateTime SemesterStrartingDate = StartingDate;
            Response.Write(SemesterStrartingDate + " " + System.DateTime.Now.Date);
            while (SemesterStrartingDate < System.DateTime.Now.Date)
            {
                SemesterStrartingDate = SemesterStrartingDate.Date.AddMonths(1);
                //Response.Write(SemesterStrartingDate.ToString("MMM"));
