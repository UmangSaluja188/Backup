    ...
    public partial class StudentLogIn : System.Web.UI.Page
    {
        ...
        protected void LogIn_Click(object sender, EventArgs e)
        {
            /* SqlCommand SelAdminIdAndPass = new SqlCommand("Select * From LoginTable Where UserId='" + Convert.ToInt32(UserId.Text) + "' AND Password='@PasswordP'", con1);
              ...
              con1.Close();
              */
            SqlDataAdapter SelectAdminIdPas = new SqlDataAdapter("Select * From LoginTable Where UserId='" + UserId.Text + "'AND Password='" + Password.Text + "' And LogInType='Student'", con1);
