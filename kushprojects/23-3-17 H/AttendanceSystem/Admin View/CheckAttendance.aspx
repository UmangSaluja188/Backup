...
<asp:Content ID="C1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="pre-scrollable">
       <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-condensed table-hover table-responsive bg-warning text-warning" HeaderStyle-BackColor="#B69782" HeaderStyle-ForeColor="#ffffff">
           <Columns>
