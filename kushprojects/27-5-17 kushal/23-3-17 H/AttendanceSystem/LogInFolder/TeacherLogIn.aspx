<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherLogIn.aspx.cs" Inherits="AttendanceSystem.LogInFolder.TeacherLogIn" %>
...
<div><asp:Image ID="Img1" runat="server" height="85px" Width="85px" ImageUrl="~/Images/Teacher4.jpg"  CssClass="Ima" />
    </div>
    ...
    <div style="margin-top:30px">
        ...
        <table>
            <tr>
                <td>
                    <asp:TextBox ID="UserId" runat="server" Height="30px" OnTextChanged="UserId_TextChanged" Width="200px" CssClass="TextBoxBorder"  placeholder="Teacher Id" ></asp:TextBox>
                </td>
            ...
            <asp:Panel ID="NewPassword" runat="server" Visible="false">
                ...
                <td>
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click"  Text="Log In" Width="204px" Height="35px"  BackColor="#00B4B4"  ForeColor="White" CssClass="TextBoxBorder"/>
                </td>
            </tr>
            </asp:Panel>
