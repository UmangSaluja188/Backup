<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogInPage.aspx.cs" Inherits="AttendanceSystem.LogInFolder.AdminLogInPage" %>
...
<div class="innerDiv">
<div style="background-color:#00B4B4;height:90px;border-top-left-radius:8px;border-top-right-radius:8px">
    
<div><asp:Image ID="Img1" runat="server" height="85px" Width="85px" ImageUrl="~/Images/admin.jpg"  CssClass="Ima" />
    </div>
    ...
    <div style="margin-top:30px">
        ...
        <table>
            <tr>
                <td>
                    <asp:TextBox ID="UserId" runat="server" Height="30px" OnTextChanged="UserId_TextChanged" Width="200px" CssClass="TextBoxBorder"  placeholder="Admin Id" ></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="LogIn" runat="server" OnClick="LogIn_Click"  Text="Log In" Width="204px" Height="35px" BackColor="#00B4B4" ForeColor="White" CssClass="TextBoxBorder"/>
                </td>
            </tr>
          </asp:Panel>
            <asp:Panel ID="NewPassword" runat="server" Visible="false">
                ...
                <tr>
                    <td>
                       <asp:TextBox ID="ConfPass" runat="server"  TextMode="Password" Height="30px" style="margin-bottom: 2px" Width="200px" CssClass="TextBoxBorder"  placeholder="New Password" ></asp:TextBox>
                    </td>
                     <td>
                ...
                <td>
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click"  Text="Log In" Width="204px" Height="35px" BackColor="#3CFF87" ForeColor="White" CssClass="TextBoxBorder"/>
                </td>
            </tr>
            </asp:Panel>
