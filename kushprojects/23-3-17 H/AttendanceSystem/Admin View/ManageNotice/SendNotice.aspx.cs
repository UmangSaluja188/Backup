...
namespace AttendanceSystem.Admin_View.ManageNotice
{
    public partial class SendNotice : System.Web.UI.Page
    {
        ...
        public static int SemesterId1,value;
        ...
        protected void Send_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Response.Write("<script type=\"text/javascript\">" + "alert('Please Enter Valid Student Id');" + "</script>");
                }
            }
            catch (Exception err)
            {
        ...
        protected void StudentId2_TextChanged(object sender, EventArgs e)
        {
            SqlDataAdapter SelStu = new SqlDataAdapter("Select * From StudentDetails Where StudentId='" + StudentId2.Text + "'", con);
            DataSet ds = new DataSet();
            SelStu.Fill(ds);
