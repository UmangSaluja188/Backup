       ...
       <div>
               <nav class="navbar navbar-inverse navbar-fixed-top">
                   <div class="container bg-muted">
                     ...
                     <asp:LinkButton ID="Log" runat="server" Text="Log In" style="font-size:18px; color:white;margin-top:15px;float:right;margin-left:10px" OnClick="Log_Click"></asp:LinkButton>
